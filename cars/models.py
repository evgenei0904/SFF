...
class UserProfile(models.Model):
    ...
    service_company = models.ForeignKey(to='service.ServiceCompany', blank=True, null=True, on_delete=models.PROTECT,
...
class Car(models.Model):
    ...
    service_company = models.ForeignKey(to='service.ServiceCompany', on_delete=models.CASCADE,
                                        verbose_name='Сервисная компания')
